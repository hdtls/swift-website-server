...
extension Experience: Serializing {
    ...
    func dataTransferObject() throws -> SerializedObject {
        ...
        dataTransferObject.companyName = companyName
        dataTransferObject.location = location
        dataTransferObject.startDate = startDate
        dataTransferObject.endDate = endDate
        dataTransferObject.headline = headline
        dataTransferObject.responsibilities = responsibilities
        dataTransferObject.media = media
        dataTransferObject.industries = industries.compactMap({ try? $0.dataTransferObject() })
